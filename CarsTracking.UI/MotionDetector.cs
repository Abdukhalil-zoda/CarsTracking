...
namespace CarsTracking
{
    ...
    public class MotionDetector
    {
        ...
        private const int MIN_BBOX_SIZE = 1;
...
/*
                    var bg = new Bitmap(new Bitmap("e:\\clean.png"), 1280, 720);
                    using (var gg = Graphics.FromImage(bg))
                    {
                        g.DrawImage(sourceFrame, rect.X, rect.Y, rect, GraphicsUnit.Pixel);

                    }
                    g.DrawImage(bg, new Rectangle(0, 0, sourceFrame.Width, sourceFrame.Height));
*/
